...
* **Managing SFTP Servers**
  ...
  * [Monitoring server capacity, [!UICONTROL whitelisting] IP addresses, and adding SSH keys](/help/tutorials/administrating/control-panel/monitoring-server-capacity-whitelisting-adding-ssh-key.md)
